...
Rubix.prototype.bisectLeft = d3.bisector(function (d) {
    return d.x;
}).left;
Rubix.prototype.bisectRight = d3.bisector(function (d) {
    return d.x;
}).right;
            ...
            if (this.master_detail) {
                ...
                if (!forced) {
                    ...
                    createdMdPath.attr('class', 'layer')
                        .attr('d', function (d) {
                            return self.master_area(d.values);
                        })
                        .attr('fill', function (d) {
                            return d.color;
                        })
...
Rubix.PieDonut.prototype.final_draw = function (animate) {
    ...
    var path = g.attr('id', function (d) {
        ...
        return d.data.color;
    }).style('stroke', 'white').append("path").attr("d", function (d) {
        return arc({
            startAngle: 0,
            endAngle: 0
        });
...
Rubix.ColumnSeries.prototype._createRect = function () {
    ...
    var rect = this.columnGroup.selectAll('rect').data(function (d) {
        return d.values;
    }).enter().append('rect').attr('stroke', strokecolor);
    if (this.grouped) {
        if (this.rubix.opts.invertAxes) {
        ...
        if (!isConstructed) {
            try {
                ...
                this.columnGroup.attr('class', 'column-layer')
                    .attr('fill', function (d) {
                        return d.color;
                    }).attr('fill-opacity', this.opts.fillopacity);
